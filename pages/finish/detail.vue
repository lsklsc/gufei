	...
	<view class="content">
		<view class="list">
			<view class="list-item border">
				...
				<view class="item-content"><text>{{result.org_name}}</text></view>
			</view>
			<view class="list-item border">
				<view class="item-title"><text class="name">垃圾类型</text></view>
				<view class="item-content"><text>{{result.rubbish_type_name}}</text></view>
			</view>
			<view class="list-item border">
			...
			<!-- <view class="list-item border">
				<view class="item-title"><text class="name">时间</text></view>
				<view class="item-content"><text>{{momentFormateHMS(result.create_time)}}</text></view>
			</view> -->
			<view class="list-item">
				<view class="item-title"><text class="name">现场照片</text></view>
			</view>
			<view class="list-item border imgs">
				<image :src="img" mode="aspectFill" v-for="(img, index) in imgs" :key="img" @tap="previewImage(index)"></image>
			</view>
			<view class="list-item border">
			...
			<view class="list-item border">
				<view class="item-title"><text class="name">预约时间</text></view>
				<view class="item-content"><text>{{result.order_time | momentFormateHMS}}</text></view>
			</view>
			<view class="list-item border">
				<view class="item-title"><text class="name">预约修改时间</text></view>
				<view class="item-content"><text>{{result.change_order_time | momentFormateHMS}}</text></view>
			</view>
			<view class="list-item border">
