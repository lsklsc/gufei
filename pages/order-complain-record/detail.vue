<template>
	<view class="content">
		<view class="list">
			...
			<view class="list-item border" v-if="result.complain_status === 2">
				<view class="item-title"><text class="name">申诉内容</text></view>
				<view class="item-content">
					<text>{{ result.content || '无' }}</text>
				</view>
			</view>
			<view class="list-item border" v-if="result.complain_status === 3 || result.complain_status === 4">
				<view class="item-title"><text class="name">处理结果</text></view>
				<view class="item-content">
