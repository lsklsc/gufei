<template>
	<view class="page-warp">
		...
		<swiper class="swiper" :current="curIndex" @change="swiperChange">
			<!-- -->
			<swiper-item>
				<order-list-item :i="0" :index="curIndex"></order-list-item>
			</swiper-item>
			
			<!--  -->
			<swiper-item>
				<order-list-item :i="1" :index="curIndex"></order-list-item>
			</swiper-item>
			<!--  -->
			<swiper-item>
				<order-list-item :i="2" :index="curIndex"></order-list-item>
			</swiper-item>
		</swiper>
	</view>
</template>
